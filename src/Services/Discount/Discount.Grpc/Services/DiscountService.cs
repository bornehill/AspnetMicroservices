...
namespace Discount.Grpc.Services
{
    public class DiscountService : DiscountProtoService.DiscountProtoServiceBase
    {
        ...
        public override async Task<CouponModel> CreateDiscount(CreateDiscountRequest request, ServerCallContext context)
        {
            ...
            _logger.LogInformation("Discount is succefully created with ProductName : {productName}", coupon.ProductName);
        ...
        public override async Task<CouponModel> UpdateDiscount(UpdateDiscountRequest request, ServerCallContext context)
        {
            ...
            _logger.LogInformation("Discount is succefully update for ProductName : {productName}", coupon.ProductName);
